"""
Django settings for ai_app_1 project.
...
WSGI_APPLICATION = 'ai_app_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ai_app_1 API",
    "DESCRIPTION": "API documentation for ai_app_1 App",
    "VERSION": "v1",
}
